...
const Nitrous = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-nitrous-900 via-cyan-900 to-nitrous-900 text-white flex flex-col">
      <Navbar />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  to="/support" 
                  className="inline-flex items-center gap-2 bg-nitrous-600 hover:bg-nitrous-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 w-fit"
                >
                  <ArrowLeft className="w-4 h-4" />
                  Back to Support Options
                </Link>
                
                <div className="flex-1 flex items-center bg-nitrous-900/30 border border-dashed border-nitrous-500/50 rounded-lg px-4 py-2">
                  <AlertTriangle className="w-5 h-5 text-red-400 mr-2 flex-shrink-0" />
                  <p className="text-red-300 text-sm">
                    Nitrous contributions are non-refundable
                  </p>
                </div>
              </div>
              ...
              <div className="text-center space-y-4">
                <h1 className="text-4xl md:text-5xl font-bold flex items-center justify-center gap-3">
                  ...
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-nitrous-400 to-cyan-400">
                    SUPPORT WITH NITROUS
                  </span>
                </h1>
                
                <p className="text-xl text-gray-300">
                  <span className="font-semibold text-nitrous-400">₹{NITROUS_AMOUNT}</span> – Maximum acceleration for breakthroughs
                </p>
              </div>
              
              <div className="bg-gray-800/50 border border-dashed border-nitrous-500 rounded-xl p-6 space-y-4">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold">Fuel with Nitrous</h3>
            ...
            <div className="space-y-6">
              <div className="bg-gray-800/50 border border-dashed border-nitrous-500 rounded-xl p-6 space-y-6">
                <h2 className="text-xl font-semibold text-center text-nitrous-400">
                ...
                <div className="space-y-4">
                  <div className="flex flex-col items-center">
                    <img
                      ...
                      loading="lazy"
                    />
                    <p className="mt-2 text-gray-300">Scan QR code to pay ₹{NITROUS_AMOUNT}</p>
                  </div>
