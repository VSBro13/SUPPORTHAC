...
const ExtraFuel = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-900 via-rose-900 to-red-900 text-white flex flex-col">
      <Navbar />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  to="/support" 
                  className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 w-fit"
                >
                  <ArrowLeft className="w-4 h-4" />
                  Back to Support Options
                </Link>
                
                <div className="flex-1 flex items-center bg-red-900/30 border border-solid border-red-500/50 rounded-lg px-4 py-2">
                  <AlertTriangle className="w-5 h-5 text-red-400 mr-2 flex-shrink-0" />
                  <p className="text-red-300 text-sm">
                    Extra Fuel contributions are non-refundable
                  </p>
                </div>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-xl text-gray-300">
                  <span className="font-semibold text-red-400">₹{EXTRA_FUEL_AMOUNT}</span> – Premium boost for intense sessions
                </p>
              </div>
              
              <div className="bg-gray-800/50 border border-solid border-red-500 rounded-xl p-6 space-y-4">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold">Fuel with Extra Fuel</h3>
            ...
            <div className="space-y-6">
              <div className="bg-gray-800/50 border border-solid border-red-500 rounded-xl p-6 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex flex-col items-center">
                    <img
                      src="/extrafuel-qr.jpg"
                      alt="UPI Payment QR Code"
                      className="w-48 h-48 rounded-lg border-2 border-gray-700 object-cover"
                      loading="lazy"
                    />
                    <p className="mt-2 text-gray-300">Scan QR code to pay ₹{EXTRA_FUEL_AMOUNT}</p>
                  </div>
